 ...
 * quarter the size and on paper instead of on the dark. A page about returning to one
 * thing ends by returning to one thing, and
    ...
    <section className="pc-s pc-s--warm pc-enq" id="pc-enquire">
      <div className="pc-rail pc-enq__in">
        <figure className="pc-enq__fig" data-pc="up">
          ...
          <figcaption>
            <Cap>The window this page opened with, shown again.</Cap>
          </figcaption>
        </figure>
        ...
        <div className="pc-enq__say">
          ...
          <p className="pc-enq__lead" data-pc="up">
            There is no timetable on this page because none has been supplied for it. Dates,
            formats and fees for Praṇava&rsquo;s practice programmes are not published here yet,
            and a plausible-looking one would be worse than none.
          </p>
